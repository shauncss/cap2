...
export default function LoginPage() {
  ...
  // 1. ADD STATE FOR SHOW/HIDE PASSWORD
          ...
          <div>
            ...
            <div className="relative">
              <input 
                ...
                name="password"
                className="w-full p-4 rounded-xl bg-gray-50 border-2 border-gray-100 focus:border-blue-500 outline-none text-gray-800 font-medium transition pr-12" // Added pr-12 for space
                placeholder="••••••••"
                onChange={handleChange}
                required 
              />
              
              {/* 3. ADD EYE ICON BUTTON */}
              <button 
                type="button"
